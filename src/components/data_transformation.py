...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            logging.info(
                "Transformers Initialized: StandardScaler-MinMaxScaler")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            logging.info(
                "Input and Target cols defined for both train and test df.")

            # Apply custom transformations in specified sequence
            input_feature_train_df = self._map_gender_column(
                input_feature_train_df)
            input_feature_train_df = self._drop_id_column(
                input_feature_train_df)
            ...
            logging.info(
                "feature-target concatenation done for train-test df.")
